...
parser.add_argument('--dataset_path', type=str, required=False, help='path to MSCOCO dataset', default='/home/xia/Dataset/COCO/2017')
parser.add_argument('--output_path', type=str, required=False,  help='output path for generated annotation txt files, default=%(default)s', default='../../outputs')
parser.add_argument('--classes_path', type=str, required=False, help='path to class definitions', default='/home/xia/Dataset/COCO/coco_classes.txt')
