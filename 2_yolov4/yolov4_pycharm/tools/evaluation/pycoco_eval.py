...
def main():
    ...
    parser.add_argument('--result_txt', required=False, type=str, help='txt detection result file', default='/home/xia/Documents/1_code/16_target_detection/target_detection/2_yolov4/yolov4_pycharm/outputs/detection_result.txt')
    parser.add_argument('--coco_annotation_json', required=False, type=str, help='coco json annotation file', default='/home/xia/Dataset/COCO/2017/annotations/instances_val2017.json')
    parser.add_argument('--coco_result_json', required=False, type=str, help='output coco json result file, default=%(default)s', default='/home/xia/Documents/1_code/16_target_detection/target_detection/2_yolov4/yolov4_pycharm/outputs/coco_result.json')
